        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="./orders.php">Orders <?php echo mysqli_fetch_array(mysqli_query($conn, "SELECT COUNT(*) AS total_complaints FROM `orders` WHERE `customersId` = '$_SESSION[userId]'"))['total_complaints'];
                                   ?></a></a>
                    </li>
