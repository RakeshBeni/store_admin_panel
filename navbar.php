<nav class="navbar bg-dark border-bottom border-body navbar-expand-lg bg-body-tertiary" data-bs-theme="dark">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <button class="btn btn-secondary p-0 mx-3 btn-sm">
  ...
  <path d="M8.707 1.5a1 1 0 0 0-1.414 0L.646 8.146a.5.5 0 0 0 .708.708L2 8.207V13.5A1.5 1.5 0 0 0 3.5 15h9a1.5 1.5 0 0 0 1.5-1.5V8.207l.646.647a.5.5 0 0 0 .708-.708L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293zM13 7.207V13.5a.5.5 0 0 1-.5.5h-9a.5.5 0 0 1-.5-.5V7.207l5-5z"/>
                    ...
                    <li class="nav-item">
                    <button class="btn btn-secondary p-0 mx-2 btn-sm">
...
</svg> Dispatched <?php echo mysqli_fetch_array(mysqli_query($conn, "SELECT COUNT(*) AS newOrders FROM orders  WHERE `orderConfirmation` = '1' AND `trakingNo` IS NOT NULL ;"))['newOrders']; ?></a>
                    </button>
                    </li>
                </ul>
