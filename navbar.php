        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item mx-2">
                    <button class="col-6 col-lg-12 m-2 btn btn-secondary p-0 btn-sm">
                        <a class="nav-link active" aria-current="page" href="index.php"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-house" viewBox="0 0 16 16">
                ...
                <li class="nav-item mx-2">
                    <button class="btn btn-secondary p-0 col-6 col-lg-12 m-2 btn-sm">
                        <a class="nav-link active" aria-current="page" href="./dispatchedOrders.php"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bus-front-fill" viewBox="0 0 16 16">
                            ...
                            </svg> Dispatched <?php echo mysqli_fetch_array(mysqli_query($conn, "SELECT COUNT(*) AS newOrders FROM orders  WHERE `orderConfirmation` = '1' AND `trakingNo` IS NOT NULL AND `FinalStatus` IS NULL ;"))['newOrders']; ?></a>
                    </button>
                </li>
                <li class="nav-item mx-2">
                    <div class="dropdown">
                        <button class="col-6 col-lg-12 m-2 btn btn-secondary dropdown-toggle " type="button" data-bs-toggle="dropdown" aria-expanded="false">
